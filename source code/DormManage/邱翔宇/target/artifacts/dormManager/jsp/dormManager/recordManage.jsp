...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-container ">
            <div class="row row1">
                ...
                <div class="layui-col-md2 btn-add">
                    <a class="layui-btn layui-btn-normal" id="addUser" href="user/dormManager/record/add"><i
    ...
    <script>
        ...
        layui.use(["laydate","table"], function () {
            ...
            table.render({
                elem: "#list",//通过id绑定容器
                url: "user/dormManager/record/list",//数据接口
                cols: [[
            ...
            $("#search").click(function () {
                ...
                table.reload("list", {
                    url: 'user/dormManager/record/search',
                    where: {
            ...
            table.on('tool(test)', function (obj) {
                ...
                if (eventName === "delete") {
                    layer.confirm("您确认要删除吗?", function (index) {
                        ...
                        obj.del();
                        layer.close(index);
                        location.href = 'user/dormManager/record/delete?id=' + needDeleteId;
                    })
                }
                if (eventName === "update") {
                    layer.confirm("您确认要修改吗?", function (index) {
                        ...
                        layer.close(index);
                        location.href = 'user/dormManager/record/update?id=' + needUpdateId;
                    });
                }
            });
        });
