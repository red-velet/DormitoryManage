...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-container ">
            <div class="row row1">
                ...
                <div class="layui-col-md2 btn-add">
                    <a class="layui-btn layui-btn-normal" id="addUser" href="user/dormManager/student/add"><i
                            class="layui-icon layui-icon-add-1"></i> 添加学生</a>
                </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <select name="quiz1" id="condition">
                                    ...
                                    <option value="nickname" selected="">名字</option>
    ...
    <script>
        ...
        layui.use("table", function () {
            ...
            table.render({
                elem: "#list",//通过id绑定容器
                url: "user/dormManager/student/list",//数据接口
                cols: [[
                    ...
                    {field: "tel", title: "电话", sort: true, edit: false},
                    {field: "buildName", title: "宿舍楼", edit: false},
            ...
            $("#search").click(function () {
                ...
                table.reload("list", {
                    url: 'user/dormManager/student/search',
                    where: {
            ...
            table.on('tool(test)', function (obj) {
                ...
                if (eventName === "delete") {
                    layer.confirm("您确认要删除吗?", function (index) {
                        ...
                        obj.del();
                        layer.close(index);
                        location.href = 'user/dormManager/student/delete?id=' + needDeleteId;
                    })
                }
                if (eventName === "update") {
                    layer.confirm("您确认要修改吗?", function (index) {
                        ...
                        layer.close(index);
                        location.href = 'user/dormManager/student/update?id=' + needUpdateId;
                    });
                }
            });
        });
