...
<div class="layui-layout layui-layout-admin">
            ...
            <form class="layui-form layui-form-pane">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="name" lay-verify="required" placeholder="请填写宿舍名称" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <textarea name="remark" required lay-verify="required" placeholder="请填写宿舍楼简介"
                                  class="layui-textarea"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <button class="layui-btn" type="button" lay-submit="" lay-filter="addBuild"><i
    ...
    <script>
        ...
        layui.use(['form', 'layer'], function () {
            ...
            //异步进行添加学生操作
            form.on('submit(addBuild)', function (data) {
                data = data.field;
                //输入验证
                if (data.name === '') {
                    layer.msg('宿舍楼名称不能为空');
                ...
                add(data.name, data.remark);
            });

            function add(name, remark) {
                $.post('user/admin/build/add',
                    {
                        "name": name,
                        "remark": remark
                    },
