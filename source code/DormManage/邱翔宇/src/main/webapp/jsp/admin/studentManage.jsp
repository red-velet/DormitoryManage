...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-container ">
            <div class="row row1">
                ...
                <div class="layui-col-md2 btn-add">
                    <a class="layui-btn layui-btn-normal" id="addUser" href="user/admin/student/add"><i
    ...
    <script>
        ...
        layui.use("table", function () {
            ...
            table.render({
                elem: "#list",//通过id绑定容器
                url: "user/admin/student/list",//数据接口
                cols: [[
            ...
            table.on('tool(test)', function (obj) {
                ...
                if (eventName === "delete") {
                    layer.confirm("您确认要删除吗?", function (index) {
                        ...
                        obj.del();
                        layer.close(index);
                        location.href = 'user/admin/student/delete?id=' + needDeleteId;
                    })
                }
                if (eventName === "update") {
                    layer.confirm("您确认要修改吗?", function (index) {
                        ...
                        layer.close(index);
                        location.href = 'user/admin/student/update?id=' + needUpdateId;
                    });
                }
            });
        });
